...
$sql = "SELECT pid,pname,price,imgurl FROM product_covid WHERE pid=$pid ";
...
$sql = "INSERT INTO cart(pid, prname, cust_name) VALUES('$pid','$prname','$uname')";
...
<body>
	<div class="login-div">
		...
		<br>
		<div class="title2">Category: COVID Essentials</div>
		<div class="title2">
			<p id="userID">
			<?php
					$name = $_SESSION['name'];
