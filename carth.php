...
<?php
session_start();
$prhname=$_POST['prhname'];
$pid=$_POST['pid'];
$uname=$_SESSION['name'];



$sql = "SELECT pid,hname,hprice,imgurl FROM product_hospitals WHERE pid=$pid ";
...
$sql = "INSERT INTO carth(pid, prhname, cust_name) VALUES('$pid','$prhname','$uname')";
...
<body>
	<div class="login-div">
		...
		<br>
		<div class="title2">Category: Hospitals</div>
		<div class="title2">
			<p id="userID">
			<?php
					$name = $_SESSION['name'];
